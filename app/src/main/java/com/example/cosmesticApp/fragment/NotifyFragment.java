...
public class NotifyFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull @NotNull GoogleMap googleMap) {
        db.collection("ThongTinCuaHang").document("XmLMpyG8xp79JfrY66ho").get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
            @Override
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                ...
                // Thêm marker trên vị trí mặc định
