...
import com.example.cosmesticApp.Adapter.HoaDonAdapter;
import com.example.cosmesticApp.Models.HoaDon;
import com.example.cosmesticApp.Presenter.HoaDonPreSenter;
import com.example.cosmesticApp.R;
import com.example.cosmesticApp.my_interface.HoaDonView;
...
//        Log.d("position","trạng thái là: " + positionStatus);
    ...
    private void Init() {
        ...
        // Tạo bản đồ lưu trữ thông tin email và iduser
        Map<String, String> emailToIduserMap = new HashMap<>();
        ...
        db.collection("IDUser").get().addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
            ...
            public void onSuccess(@NonNull QuerySnapshot queryDocumentSnapshots) {
                for(QueryDocumentSnapshot d : queryDocumentSnapshots){
                    ...
                    String idusers = d.getString("iduser");
                    emailToIduserMap.put(email, idusers);
                    mlistUser.add(email);
                    ArrayAdapter arrayAdapter2 = new ArrayAdapter(AdminBillMainActivity.this, R.layout.support_simple_spinner_dropdown_item, mlistUser /*new ArrayList<String>(emailToIduserMap.keySet())*/);
